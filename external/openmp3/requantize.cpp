...
namespace OpenMP3
{
	...
	void RequantizeLong(const mp3_frame_data & data, UInt gr, UInt ch, UInt is_pos, UInt sfb, Float32 is[576]);

	void RequantizeShort(const mp3_frame_data & data, UInt gr, UInt ch, UInt is_pos, UInt sfb, UInt win, Float32 is[576]);
...
void OpenMP3::Requantize(UInt sfreq, const mp3_frame_data & data, UInt gr, UInt ch, Float32 is[576])
{
...
void OpenMP3::Reorder(UInt sfreq, const mp3_frame_data & data, UInt gr, UInt ch, Float32 is[576])
{
...
void OpenMP3::RequantizeLong(const mp3_frame_data & data, UInt gr, UInt ch, UInt is_pos, UInt sfb, Float32 is[576])
{
	ASSERT(is_pos < 576);
...
void OpenMP3::RequantizeShort(const mp3_frame_data & data, UInt gr, UInt ch, UInt is_pos, UInt sfb, UInt win, Float32 is[576])
{
	ASSERT(is_pos < 576);
