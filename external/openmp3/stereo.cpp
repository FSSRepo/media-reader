...
namespace OpenMP3
{
	...
	void StereoIntensityLong(UInt sfreq, const mp3_frame_data & data, UInt gr, UInt sfb, Float32 is[2][576]);

	void StereoIntensityShort(UInt sfreq, const mp3_frame_data & data, UInt gr, UInt sfb, Float32 is[2][576]);
...
void OpenMP3::Stereo(UInt sfreq, UInt8 joint_stereo_mode, const mp3_frame_data & data, unsigned gr, Float32 is[2][576])
{
...
void OpenMP3::StereoIntensityLong(UInt sfreq, const mp3_frame_data & data, unsigned gr, unsigned sfb, Float32 is[2][576])
{
...
void OpenMP3::StereoIntensityShort(UInt sfreq, const mp3_frame_data & data, unsigned gr, unsigned sfb, Float32 is[2][576])
{
